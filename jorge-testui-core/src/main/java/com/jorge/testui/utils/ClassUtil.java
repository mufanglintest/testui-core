...
//        List<Class> classes = ClassUtil.getAllClassByInterface(Class.forName("com.threeti.dao.base.IGenericDao"));
        List<Class<?>> daoClass = ClassUtil.getClasses("com.autotest.js.customer.dao");
//        for (Class clas : classes) {
//            System.out.println(clas.getName());
//        }
        for (Class<?> aClass : daoClass) {
            String daoClassName = aClass.getSimpleName();
            String name = daoClassName.substring(0, 1).toLowerCase() + daoClassName.substring(1);
            System.out.println("@Resource");
            System.out.println(daoClassName+" "+name+";");
        }

        String jsonString = "{\"name\":\"mfl\",\"age\":\"111\"}";
    ...
    public static Object mapToObject(Map<String, String> map, Class<?> beanClass) throws Exception {
        ...
        for (Field field : fields) {
            ...
            if (field.getType() == String.class) {
                ...
                field.set(obj, fieldValue.charAt(0));
            } else if (field.getType() == Byte.class) {
                field.set(obj, Byte.parseByte(fieldValue));
