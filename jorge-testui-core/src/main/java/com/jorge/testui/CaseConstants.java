...
public final class CaseConstants {
    public static final String PERFORMANCE_LOGGER = "com.jorge.testui_PERFORMANCE_LOGGER";
    ...
    public static final String DEFAULT_ACCOUNT_NO = "19120911492835200036";

    public static final Money AMOUNT_ZERO = new Money();
